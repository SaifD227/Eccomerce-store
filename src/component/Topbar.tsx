    ...
    <div className="flex flex-col md:flex-row justify-between items-center bg-orange-600 shadow-md h-auto px-4 md:px-8 lg:px-16 py-4">
      ...
      <div className="flex items-center space-x-6 mt-4 md:mt-0">
        ...
        <p className="cursor-pointer relative flex items-center">
          <span className="absolute bottom-8 right-0 bg-red-500 text-white text-xs font-bold rounded-full px-2 py-1">
            {cart.length}
          </span>
          <Link to="/cart">   <PiShoppingCartSimple size={40} className="text-white" /></Link>
